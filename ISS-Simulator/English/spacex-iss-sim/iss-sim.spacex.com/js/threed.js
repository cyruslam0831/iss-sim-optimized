...
function hideInterface(t) {
    (isGameOver = !0),
        ...
        "success" === t &&
            ...
            ($("#success-message").innerHTML = "Time: " + min.toString().padStart(2, "0") + ":" + sec.toString().padStart(2, "0"))
        "fail" === t &&
...
function toggleTimer() {
    if (timeLimit === -1) {
        timeLimit = 60000;
        $("#setting-timer span").innerHTML = "1 MIN"
    } else if (timeLimit === 60000) {
        timeLimit = 120000;
        $("#setting-timer span").innerHTML = "2 MIN"
    } else if (timeLimit === 120000) {
        timeLimit = 180000;
        $("#setting-timer span").innerHTML = "3 MIN"
    } else if (timeLimit === 180000) {
        timeLimit = 300000;
        $("#setting-timer span").innerHTML = "5 MIN"
    } else {
        timeLimit = -1;
...
function toggleDifficulty() {
    if (difficulty == 1) {
        ...
        toleranceRate = 0.006
        toleranceRotation = 0.4
        $("#setting-difficulty span").innerHTML = ("NORMAL")
    } else if (difficulty == 2) {
        difficulty = 3
        toleranceRate = 0.004
        toleranceRotation = 0.2
        $("#setting-difficulty span").innerHTML = ("HARD")
    } else {
        difficulty = 1
        toleranceRate = 0.008
        toleranceRotation = 0.6
        $("#setting-difficulty span").innerHTML = ("EASY")
    }
}
